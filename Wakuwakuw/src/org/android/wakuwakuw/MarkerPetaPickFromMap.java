...
public class MarkerPetaPickFromMap extends ItemizedOverlay {
	...
	public MarkerPetaPickFromMap(Drawable defaultMarker, Context context) {
	...
	*/
	...
	public boolean onTouchEvent(MotionEvent event, MapView mapView) {
		...
		if (event.getAction() == 1) {
			...
			PetaPickFromMap.finalLatPoint = Double.toString((double)(p.getLatitudeE6()/1E6));
			PetaPickFromMap.finalLongPoint = Double.toString((double)(p.getLongitudeE6()/1E6));
